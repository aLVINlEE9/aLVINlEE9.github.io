...
|  s<sub>1</sub> (v = 0.032)   | s<sub>2</sub> (v = 0.150952) | s<sub>3</sub> (v =  0.8)  |
| :--------------------------: | :--------------------------: | :-----------------------: |
| **s<sub>4</sub> (v = 0.64)** | **s<sub>5</sub> (v = 0.8)**  | **s<sub>6</sub> (v = 1)** |
| **s<sub>7</sub> (v = 0.8)**  |  **s<sub>8</sub> (v = 1)**   | **s<sub>9</sub> (v = 0)** |

### V<sub>π</sub>(s<sub>1</sub>) = [1 * (0 + 0.8 * (0.04))] = 0.032
...
방금 4번의 iteration을 직접 해보니 신기하게도 policy가 goal 있는 지점으로 action을 하는 모습을 보였다.
